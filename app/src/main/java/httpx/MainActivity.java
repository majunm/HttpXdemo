...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(kaiqi.cn.httpx.R.layout.activity_main);
        mTst1 = (TextView) findViewById(kaiqi.cn.httpx.R.id.tst1);
        mTst2 = (TextView) findViewById(kaiqi.cn.httpx.R.id.tst2);
        mTst3 = (TextView) findViewById(kaiqi.cn.httpx.R.id.tst3);
        mTst4 = (TextView) findViewById(kaiqi.cn.httpx.R.id.tst4);
        mContent = (TextView) findViewById(kaiqi.cn.httpx.R.id.content);
